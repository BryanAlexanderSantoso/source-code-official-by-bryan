...
const Collaborations: React.FC = () => {
  const collaborations = [
    {
      ...
      testimonial: "Collaborating with Kaze Serenity was an incredible experience. The community is incredibly supportive and engaging!",
      highlight: "Exclusive Gaming Tournament",
      subscribers: "1.2M+"
    },
    {
      name: "Wielino",
      ...
      testimonial: "The Kaze Serenity community brings such positive energy to every collaboration. It's always a highlight of my month!",
      highlight: "Interactive Livestream Series",
      subscribers: "850K+"
    }
  ];
  ...
  const prevSlide = () => {
    setActiveIndex((current) => (current - 1 + collaborations.length) % collaborations.length);
  };

  return (
    <section id="collaborations" className="py-16 md:py-24 bg-gradient-to-b from-white to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Exclusive Collaborations</h2>
          <div className="w-20 h-1.5 bg-indigo-600 mx-auto mb-8 rounded-full"></div>
          <p className="max-w-3xl mx-auto text-lg text-gray-600">
            We've partnered with some of the most exciting content creators to bring unique experiences to our community.
          </p>
        </div>
                  ...
                  <div className="md:flex bg-white rounded-2xl overflow-hidden">
                    <div className="md:w-2/5 relative h-64 md:h-auto">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <div className="flex items-center">
                          ...
                          <span className="text-white text-sm">{collab.subscribers} subscribers</span>
                        </div>
                      </div>
                    </div>
                    <div className="md:w-3/5 p-6 md:p-8 flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-2">{collab.name}</h3>
                        <p className="text-indigo-600 mb-4">{collab.role}</p>
                        <blockquote className="italic text-gray-600 border-l-4 border-indigo-300 pl-4 mb-6">
                          "{collab.testimonial}"
                        </blockquote>
                      </div>
                      <div className="mt-4">
